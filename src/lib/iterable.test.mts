...
describe('iterableUtils', function () {
	describe('isIterable', function () {
		it('should return true for iterable objects', async function () {
			expect(isIterable([])).to.equal(true);
			expect(isIterable(new Set([]))).to.equal(true);
			expect(isIterable(new Map())).to.equal(true);
		});
		it('should return false for non-iterable objects', async function () {
	...
	describe('isNonIterable', function () {
		it('should return false for iterable objects', async function () {
		...
		it('should return true for non-iterable objects', async function () {
	...
	describe('isAsyncIterable', function () {
		it('should return true for async iterable objects', async function () {
			expect(isAsyncIterable((async function* () {})())).to.equal(true);
		});
		it('should return false for non-async iterable objects', async function () {
	...
	describe('isNotAsyncIterable', function () {
		it('should return false for async iterable objects', async function () {
			expect(isNotAsyncIterable((async function* () {})())).to.equal(false);
		});
		it('should return true for non-async iterable objects', async function () {
